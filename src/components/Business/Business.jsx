...
const Business = () => {
  return (
    <section className="font-montserrat bg-[#EFB400] p-12 mt-14 overflow-hidden">
                <div className="container">
                    ...
                    <div className="businer-section relative">
                        <ul className="busines-card-list w-[520px] mt-10">
                            <li className="busines-item flex gap-x-5 items-center bg-[#F6FAFD] px-9 py-5 rounded-[20px]">
                                <Image src={Card} alt="card" />
                                <p className="text-[14px] font-normal">Оплачивайте с р/с или карты компании</p>
                            </li>
                            <li className="busines-item flex my-5 gap-x-5 items-center bg-[#F6FAFD] px-9 py-5 rounded-[20px]">
